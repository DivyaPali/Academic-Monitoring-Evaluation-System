              ...
              <div class="row row1">
                    <div class="form-col">
                      <div class="col1">
                        ...
                        String sql ="select lp1t.rollno,member.name,lp1t.marks from lp1t INNER JOIN  member ON member.rollno=lp1t.rollno";
