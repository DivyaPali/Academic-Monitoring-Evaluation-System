	...
	<div class="container py-5">
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-6 pb-4">
				<h1 class=" cta-message display-4 font-weight-bold">Big Data Unit Test2 Result</h1>
                          ...
                          <div class="intro"><p>Result</p></div>
                             <div class="inputs">
                                <table class="styled-table">
									...
									String sql ="select bd2.rollno,member.name,bd2.marks from bd2 INNER JOIN  member ON member.rollno=bd2.rollno";
