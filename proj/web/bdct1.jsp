	...
	<div class="container py-5">
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-6 pb-4">
				<h1 class=" cta-message display-4 font-weight-bold">Big Data Unit Test1 Result</h1>
...
String sql ="select bd1.rollno,member.name,bd1.marks from bd1 INNER JOIN  member ON member.rollno=bd1.rollno";
