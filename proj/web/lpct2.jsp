                    ...
                    <div class="form-col">
                      <div class="col1">
                        ...
                        <tbody>
                            ...
                            String sql ="select lp2t.rollno,member.name,lp2t.marks from lp2t INNER JOIN  member ON member.rollno=lp2t.rollno";
