...
<body>  
    ...
    <div id="wrapper">
                ...
                <nav class="navbar navbar-default yamm">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown hassubmenu">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Surprise Test <span class="fa fa-angle-down"></span></a>
                              <ul class="dropdown-menu" role="menu">
                                  <li><a class="dropdown-item" href="lang.jsp">Language Processor</a></li>
                                  <li><a class="dropdown-item" href="bigdata.jsp">Big Data</a></li>
                                  <li><a class="dropdown-item" href="mcom.jsp">Mobile Computing</a></li>
                                  <li><a class="dropdown-item" href="dwm.jsp">Data warehouse and Mining</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Test as follows</li>
                            </ul>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
        ...
        <p align="center"> <iframe src="quilgo.com/t/1HRtB1hs3bqjbMbP" width="650" height="540" frameborder="0" marginheight="0" marginwidth="0" align="center">
          Loading…</iframe></p>
