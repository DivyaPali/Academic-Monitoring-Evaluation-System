...
<!--Navbar 1-->
 ...
 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
       <a class="dropdown-item" href="lang.jsp">Language Processor</a>
       <a class="dropdown-item"  href="bigdata.jsp">Big Data</a>
       <a class="dropdown-item"  href="mcom.jsp">Mobile Computing</a>
       <a class="dropdown-item"  href="dwm.jsp">Data warehouse and Mining</a>
       <a class="dropdown-item"  href="tcp.jsp">TCPIP</a>
  ...
  <ul class="navbar-nav ml-auto" style="letter-spacing:2px; font-size: 15px;">
    ...
    <p align="center"> <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdbUiLRVP71kvIkdO2nv4_Enz_shCFXGIcb6heWAkK3YSHIVg/viewform?embedded=true" width="560" height="540" frameborder="0" marginheight="0" marginwidth="0">
    Loading…</iframe></p>
