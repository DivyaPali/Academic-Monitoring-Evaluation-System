                    ...
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Get Enrolled</li>
                            </ul>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="section-title text-center">
                                <h3>Signup Form</h3>
                                <p>Fill out the details in the form below.</p>
                            </div><!-- end title -->
                            
                            <form class="big-contact-form" role="search" action="Register" method="post">
                                <input type="text" class="form-control" placeholder="Enter your name.." name="name">
                                <input type="number" class="form-control" placeholder="Enter rollno.." name="rollno">
                                <input type="number" class="form-control" placeholder="Enter semester.." name="sem">
                                <input type="email" class="form-control" placeholder="Enter email.." name="email">
                                <input type="number" class="form-control" placeholder="Your phone.." name="phone">
