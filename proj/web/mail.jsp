                ...
                <nav class="navbar navbar-default yamm">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="selectf.jsp">Back</a></li>                            
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tagline-message page-title text-center">
                    <h3>Notification Sent Through Mail</h3>
                    <ul class="breadcrumb">
...
<section class="section gb nopadtop">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="section-title text-center">
                        <h3>Notification Sent Through JSP</h3>
                        <p>Mail has been sent to following mails</p>
                    </div><!-- end title -->
                    <ul>
                      <li>
                        <%
    ...
    final String from = "divyapali007@gmail.com";

    final String pass = "GdiV1@3yaA";
...
{
		final String too=resultSet.getString("email");							
			out.println(too);						
...
<li>jyotisharma08102000@gmail.com</li>
<li>ayushimorey1@gmail.com</li>
<li>arunmorey20@gmail.com</li>
</ul>
