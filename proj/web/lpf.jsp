                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center">
                            <h3>Language Processor Internal Marks</h3>
                            <ul class="breadcrumb">
                                <li><a href="javascript:void(0)">AMAES</a></li>
                                <li class="active">Language Processor</li>
                                <li class="active">Add LP Internal Marks</li>
                            </ul>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
                      ...
                      <div class="form-col">
                        <div class="col1">
                             <div class="form-group cont">
                                <form action="Lpf" method="post">
                                  <div class="intro"><p>Fill LP Internal Marks</p></div>
                                     <div class="inputs">
