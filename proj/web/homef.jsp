                ...
                <div id="owl-01" class="owl-carousel owl-theme owl-theme-01">                    
                        ...
                        <a href="selectf.jsp">
                            <div class="course-box">
                                <div class="image-wrap entry">
                                    <img src="upload/i15.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                ...
                                <div class="course-footer clearfix">
                                    <div class="pull-left">
                                        <ul class="list-inline">
                                            <li><a href="#"><i class="fa fa-user"></i> 7 Semester</a></li>
                    ...
                    <div class="caro-item">
                        <a href="">
                            <div class="course-box">
                                <div class="image-wrap entry">
                                    <img src="upload/i16.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <i class="flaticon-add"></i>
                                    </div>
                                </div><!-- end image-wrap -->
                    ...
                    <div class="caro-item">
                        <a href="">
                            <div class="course-box">
                                <div class="image-wrap entry">
                                    <img src="upload/i19.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <i class="flaticon-add"></i>
                                    </div>
                                </div><!-- end image-wrap -->
                    ...
                    <div class="caro-item">
                        <a href="">
                            <div class="course-box">
                                <div class="image-wrap entry">
                                    <img src="upload/i17.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <i class="flaticon-add"></i>
                                    </div>
                                </div><!-- end image-wrap -->
